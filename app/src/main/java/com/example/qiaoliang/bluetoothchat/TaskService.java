...
public class TaskService extends Service {
    ...
    /**
     * wait for client connecting thread
     *
    ...
    private void manageConnectedSocket(BluetoothSocket socket) {
        // start a thread to maintain connection
    ...
    private class ConnectedThread extends Thread {
        ...
        public ConnectedThread(BluetoothSocket socket) {
            ...
            mmInStream = tmpIn;
            mmOutStream = tmpOut;
            mmBw = new BufferedWriter(new PrintWriter(mmOutStream));
        }
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    buffer= mmSocket.getRemoteDevice().getName()+": "+buffer;
